...
if ($_POST['guardar_editar']=="Guardar"){
   ...
   $fecha_nac_trz11=Fecha_db($res_benef->fields['afifechanac']);
   $fecha_taller=Fecha_db($_POST['fecha_taller']);
   $tema_taller=$_POST['tema_taller'];
   $comentario_trz11=$_POST['observaciones_trz11'];
   
   
   $query="update trazadorassps.trazadora_11 set 
            cuie='$cuie',
            id_smiafiliados='$id_smiafiliados',
            fecha_nac='$fecha_nac_trz11',
  			fecha_asis_taller='$fecha_taller',
  			tema_taller='$tema_taller',
            fecha_carga='$fecha_carga',
            usuario='$usuario',
            comentario='$comentario_trz11'           
             
             where id_trz11=$id_planilla";
...
if ($_POST['guardar']=="Guardar Planilla"){
   ...
   $sql_benef="select * from nacer.smiafiliados where id_smiafiliados=$id_smiafiliados";
   $res_benef=sql($sql_benef,"no se pudieron traer los datos de smiafiliados");
   $fecha_nac_trz11=$res_benef->fields['afifechanac'];
   ...
   $query="insert into trazadorassps.trazadora_11	
             ...
             values
             ('$id_planilla','$cuie','$id_smiafiliados','$fecha_nac_trz11',
...
<form name='form1' action='trazadora_11.php' method='POST'>
...
<table class="bordes" align="center" width="100%">
  ...
  <tr align="left">
   <td>
   	<font size="2">Trazadora XI (PROMOCION DEL DERECHO AL CUIDADO SEXUAL Y REPRODUCTIVO ENTRE LOS 14 Y LOS 25 AÑOS): Campos son todos menos Observaciones.</font>
   </td>
  </tr>
