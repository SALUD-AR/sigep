...
if ($_POST['guardar_editar']=="Guardar"){
   ...
   $fecha_nac_trz7=$res_benef->fields['afifechanac'];
   $id_beneficiarios=0;
 }
 else {
  ...
  $res_benef=sql($sql_benef,"no se pudieron traer los datos de smiafiliados");
  $fecha_nac_trz7=$res_benef->fields['fecha_nac'];
  $id_smiafiliados=0;
   };
   
   $query="update trazadorassps.trazadora_7 set 
             cuie='$cuie',
             id_smiafiliados='$id_smiafiliados',
             id_beneficiarios='$id_beneficiarios',
             fecha_nac='$fecha_nac_trz7',
             fecha_control='$fecha_control_trz7',
             peso='$peso',
  			     talla='$talla',
  			     tension_arterial='$tension_arterial',
  			     percentilo_peso_edad='$percentilo_peso_edad_trz7', 
  			     percentilo_talla_edad='$percentilo_talla_edad_trz7',
  			     percentilo_peso_talla='$percentilo_peso_talla_trz7',
             fecha_carga='$fecha_carga',
             usuario='$usuario',
             comentario='$comentario_trz7'           
             
             where id_trz7=$id_planilla";
...
$sql="select * from nacer.smiafiliados
  ...
  $apellido=trim($res_comprobante->fields['afiapellido']);
    ...
    if ($id_smiafiliados) $id_beneficiarios=$id_smiafiliados;
    $sql="SELECT * from leche.beneficiarios where id_beneficiarios='$id_beneficiarios'";
    $res_comprobante=sql($sql, "Error los datos de leche.beneficiarios") or fin_pagina();
...
<form name='form1' action='trazadora_7.php' method='POST'>
		...
		<tr>
		 ...
		 <tr>
          ...
          <tr>
           ...
           <td >
             <input type='text' name='talla' value='<?=$talla;?>' size=60 align='right'></b><font color="Red">Cm (centimetro)</font>
           </td>
          </tr>
          <tr>
           <td align="right">
...
<table class="bordes" align="center" width="100%">
  ...
  <tr align="left">
   <td>
   	<font size="2">Trazadora VII (SEGUIMIENTO DE SALUD DEL NIÑO DE 1 A 9 AÑOS): Campos son todos menos Percentilos y Observaciones.</font>
   </td>
  </tr>
