...
if ($_POST['guardar_editar']=="Guardar"){
  $fecha_carga=date("Y-m-d H:m:s");
   ...
   $fecha_diagnos=Fecha_db($_POST['fecha_diagnostico']);
   $diag=$_POST['diag'];
   ...
   $fecha_nac_trz12=$res_benef->fields['afifechanac'];
   $comentario_trz12=$_POST['observaciones_trz12'];
   
   $query="update trazadorassps.trazadora_12 set 
             cuie='$cuie',
             id_smiafiliados='$id_smiafiliados',
             fecha_nac='$fecha_nac_trz12',
  			 fecha_diagnostico='$fecha_diagnos',
  			 diagnostico='$diag',
  			 fecha_carga='$fecha_carga',
             usuario='$usuario',
             comentario='$comentario_trz12'            
             
             where id_trz12=$id_planilla";
...
if ($_POST['guardar']=="Guardar Planilla"){
   ...
   $id_planilla=$id_planilla->fields['id_planilla'];
    ...
    $query="insert into trazadorassps.trazadora_12	
             ...
             values
             ('$id_planilla','$cuie',$id_smiafiliados,'$fecha_nac_trz12',
              '$fecha_diagnos','$diag','$fecha_inic_tratamiento',
...
{ 
 ...
 if(document.all.fecha_diagnostico.value==""){
...
<form name='form1' action='trazadora_12.php' method='POST'>
   		...
   		<tr>
		    ...
		    <td align="left">
		    	<?$fecha_diagnostico=date("d/m/Y");?>
		    	 <input type=text id=fecha_diagnostico name=fecha_diagnostico
		    	  value='<?=$fecha_diagnostico;?>' size=15>
		    	 <?=link_calendario("fecha_diagnostico");?>					    	 
		    </td>		    
		</tr>	
		 <tr>
           <td align="right">
		  ...
		  <tr>
		    ...
		    <td align="left">
		    	<?$fecha_inic_tratamiento=date("d/m/Y");?>
		    ...
		    </td><font color="Red">No Obligatorio</font>		    
		</tr>
		  <tr>
         	<td align="right">
         	  <b>Observaciones:</b>
...
<table class="bordes" align="center" width="100%">
  ...
  <tr align="left">
   <td>
   	<font size="2">Trazadora XII (PREVENCION DEL CANCER CERVICO-UTERINO): Campos son todos menos Observaciones.</font>
   </td>
  </tr>
