...
if ($_POST['guardar_editar']=="Guardar"){
  $fecha_carga=date("Y-m-d");
   ...
   $fecha_nac_trz8=$res_benef->fields['afifechanac'];       
    
     
   $query="update trazadorassps.trazadora_8 set 
             cuie=$cuie',
             id_smiafiliados='$id_smiafiliados',
             fecha_nac='$fecha_nac_trz8',
             fecha_vacuna_cuad_bacteriana='$fecha_vac_cua_bact_trz8',
  			 fecha_vacuna_antipoliomelitica='$fecha_vac_antipolio_trz8',
             fecha_carga='$fecha_carga',
             usuario='$usuario',
             comentario='$comentario_trz8'            
             
             where id_trz8=$id_planilla";
...
if ($_POST['guardar']=="Guardar Planilla"){
   ...
   $id_beneficarios=0;
   	$query="insert into trazadorassps.trazadora_8	
             ...
             values
             ('$id_planilla','$cuie','$id_smiafiliados','$fecha_nac_trz8',
...
<form name='form1' action='trazadora_8.php' method='POST'>
...
<table class="bordes" align="center" width="100%">
  ...
  <tr align="left">
   <td>
   	<font size="2">Trazadora VIII (COBERTURA DE INMUNIZACIONES A LOS 24 MESE): Campos son todos menos Observaciones.</font>
   </td>
  </tr>
