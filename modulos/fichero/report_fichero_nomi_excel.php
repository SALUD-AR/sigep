...
if($cuie!='Todos'){
			$sql_tmp="SELECT 
						...
						where (fichero.fichero.fecha_control BETWEEN '$fecha_desde' and '$fecha_hasta') and (nacer.efe_conv.cuie='$cuie') and (embarazo='NO')
				...
				$sql_tmp="SELECT 
							...
							nacer.efe_conv.nombre as nom_efe
								...
								LEFT OUTER JOIN leche.beneficiarios ON leche.beneficiarios.id_beneficiarios = fichero.fichero.id_beneficiarios
								INNER JOIN nacer.efe_conv ON nacer.efe_conv.cuie = fichero.fichero.cuie
							where (fichero.fichero.fecha_control BETWEEN '$fecha_desde' and '$fecha_hasta') and (embarazo='NO')
							ORDER BY fecha_control";
