...
if ($_POST['generar_excel']=="Generar Excel"){
	...
	$link=encode_link("vac_res_detallado.php",array("fecha_desde"=>$_POST['fecha_desde'],"fecha_hasta"=>$_POST['fecha_hasta'],"cuie"=>$_POST['cuie']));
	?>
	<script>
	window.open('<?=$link?>')
	</script>	
...
<form name=form1 action="report_vac_detallado.php" method=POST>
