...
if ($_POST['muestra']=="Muestra"){
			...
			$sql_tmp="SELECT  
				...
				FROM
					fichero.fichero
				where (fecha_control BETWEEN '$fecha_desde' and '$fecha_hasta')and (cuie='$cuie')";
...
<form name=form1 action="avance_metas_fich.php" method=POST>
...
<div align="center">
	<tr>
    	<td align="center" colspan="2" class=bordes id="ma">
			<?$link_s=encode_link("avance_metas_fich_grp_small_1.php",array("periodos_array_ant"=>$periodos_array_ant,"periodos_label_array"=>$periodos_label_array,"periodos_array"=>$periodos_array,"meta_men"=>$meta_men,"meta_acu"=>$meta_acu,"meta_porcent"=>$meta_porcent));
			$link_l=encode_link("avance_metas_fich_grp_large_1.php",array("periodos_array_ant"=>$periodos_array_ant,"periodos_label_array"=>$periodos_label_array,"periodos_array"=>$periodos_array));
