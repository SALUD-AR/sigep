...
if ($_POST['generar_excel']=="Generar Excel"){
	...
	$link=encode_link("report_fichero_nomi_excel_pers.php",array("fecha_desde"=>$_POST['fecha_desde'],"fecha_hasta"=>$_POST['fecha_hasta'],"cuie"=>$_POST['cuie']));
	?>
	<script>
	window.open('<?=$link?>')
	</script>	
...
<form name=form1 action="report_fichero_nomi_pers.php" method=POST>
