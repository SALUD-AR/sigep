			...
			$sql_tmp="SELECT							
						...
						where 
							CASE WHEN leche.beneficiarios.fecha_nac IS NULL THEN
								...
								and ((fichero.fichero.fecha_control - nacer.smiafiliados.afifechanac)/365)>=$rangoedad_desde and ((fichero.fichero.fecha_control - nacer.smiafiliados.afifechanac)/365)<$rangoedad_hasta
							ELSE
								(fichero.fichero.fecha_control BETWEEN '$fecha_desde' and '$fecha_hasta') and (nacer.efe_conv.cuie='$cuie')
								and ((fichero.fichero.fecha_control - leche.beneficiarios.fecha_nac)/365)>=$rangoedad_desde and ((fichero.fichero.fecha_control - leche.beneficiarios.fecha_nac)/365)<$rangoedad_hasta
							END
...
excel_header("report_fichero_nomi_edad_excel.xls");

?>
<form name=form1 method=post action="report_fichero_nomi_edad_excel.php">
