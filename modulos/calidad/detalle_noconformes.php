...
<br>
<?
$link=encode_link("detalle_noconformes.php", array("pagina"=>$parametros['pagina'],"id" =>$parametros['id']));
?>
...
<input type="button" name="imprimir" value='Imprimir Etiqueta' <?if($parametros['pagina']=="")echo "disabled"?> onclick="window.open('<?php echo encode_link("imprimir_etiqueta.php",array("id"=>$id)) ?>','','toolbar=0,location=0,directories=0,status=0, menubar=0,scrollbars=0,left=0,top=0,width=350,height=5');">
</center>
</form>
</body>
</html>
