...
if ($_POST['guardar']=="Guardar"){   
    ...
    switch ($estado) {
    	case "A": $control=2;$id_area=2;$id_area_origen=2;break;
    	case "D": $control=3;$id_area=1;$id_area_origen=2;break;
    	case "R": $control=0;$id_area=3;$id_area_origen=2;break;
		};
...
<form name='form1' action='mod_exp.php' method='POST'>
...
<table width="60%" cellspacing=0 border=1 bordercolor=#E0E0E0 align="center" bgcolor='<?=$bgcolor_out?>' class="bordes">
 <tr id="mo">
    <td>
    	...
    	?>
        <font size=+1><b>EXPEDIENTE EN CONTROL DE GESTION</b></font>   
        <? } ?>
       ...
       <td align="center">
        <table align="center">
         ...
         <tr>
			...
			<td align="left">		    	
		    	 <input type=text id=id_factura name=id_factura value='<?=$id_expediente_fact;?>' size=50 >
         ...
         <tr>
            ...
            <td align='left'>
              <?php 
					...
					$monto=$result_monto->fields['monto_prefactura'];
...
<tr><td><table width=100% align="center" class="bordes">
  <tr align="center">
   <td>
     <input type=button name="volver" value="Volver" onclick="document.location='expediente.php'"title="Volver al Listado" style="width=150px">     
   </td>
  </tr>
 </table></td></tr>
