		...
		if (($activo=='S')&&( 
			...
			//if (($id_nomenclador_detalle > 8)&&($fecha_vac>='2012-11-01')){
				if (($id_vac_apli == '6')&&($id_dosis_apli=='1')) {
					$codigo= "V001";
					$descripcion="Dosis aplicada de vacuna triple viral en ni�os menores de 6 a�os";
				}elseif (($id_vac_apli == '6')&&($id_dosis_apli!='1')){
					$codigo= "V001";
					$descripcion="Dosis aplicada de vacuna triple viral en ni�os menores de 6 a�os";
				} elseif ($id_vac_apli == '1') {
					$codigo= "V009";
					$descripcion="Dosis aplicada de inmunizaci�n de reci�n nacido (BCG antes del alta y Hepatitis B en primeras 12 hs de vida)";
				} elseif ($id_vac_apli == '5') {
					$codigo= "V002";
					$descripcion="Dosis aplicada de Sab�n en ni�os de 2, 4, 6 y 18 meses y 6 a�os o actualizaci�n de esquema";
				} elseif ($id_vac_apli == '3') {
					$codigo= "V003";
					$descripcion="Dosis aplicada de inmunizaci�n Pentavalente en ni�os de 2, 4, y 6 meses o actualizaci�n de esquema";
				} elseif ($id_vac_apli == '4') {
					$codigo= "V004";
					$descripcion="Dosis aplicada de inmunizaci�n Cu�druple en ni�os de 18 meses o actualizaci�n de esquema";
				} elseif ($id_vac_apli == '7') {
					$codigo= "V005";
					$descripcion="Dosis aplicada de inmunizaci�n para Hepatitis A en ni�os de 12 meses o actualizaci�n de esquema";
				} elseif ($id_vac_apli == '15') {
					$codigo= "V008";
					$descripcion="Dosis aplicada de dTap triple acelular (refuerzo a los 11 a�os)";
				} elseif ($id_vac_apli == '2') {
					$codigo= "V009";
					$descripcion="Dosis aplicada de inmunizaci�n anti hepatitis B (Actualizaci�n esquema)";
				} elseif ($id_vac_apli == '10') {
					$codigo= "V010";
					$descripcion="Dosis aplicada de Doble adultos  >16 a�os";				
				} elseif ($id_vac_apli == '11') {
					$codigo= "V011";
					$descripcion="Dosis aplicada de Doble viral (rub�ola + sarampi�n)";
				} elseif ($id_vac_apli == '18') {
					$codigo= "V013";
					$descripcion="Dosis aplicada de vacuna antigripal en ni�os de 6 a 24 meses o en ni�os mayores con factores de riesgo";
				} elseif ($id_vac_apli == '19') {
					$codigo= "V013"; 
					$descripcion="Dosis aplicada de Vacuna Antigripal en personas con factores de riesgo";
				} elseif ($id_vac_apli == '14') {
					$codigo= "V014"; 
					$descripcion="Dosis aplicada de Vacuna contra VPH (Virus Papiloma Humano) en ni�as de 11 a�os ";
				} elseif (($id_vac_apli == '8')or($id_vac_apli == '9')) { //"Triple Bacteriana Acelular"
					$codigo= "V008"; 
					$descripcion="Dosis aplicada de dTap Triple Acelular (Actualizaci�n esquema en ni�os mayores 7 a�os)";
				}
			echo $id_vac_apli;
			//}
...
<form name='form1' action='der_admin.php' method='POST'>
...
<table width="85%" cellspacing=0 border=1 bordercolor=#E0E0E0 align="center" bgcolor='<?=$bgcolor_out?>' class="bordes">
 <tr id="mo">
    <td>
    	<font size=+1><b>Derivaciones</b></font>    	       
    </td>
 </tr>
 <tr><td>
       ...
       <td>
		...
		<tr>
           ...
           <td align='left'>
			 ...
			 ?>
         	 <input type='text' name='edad' value='<?echo $anio_edad." A�o/s, ".$meses_edad." Mes/es y ".$dias_edad." dia/s"?>' size=30 align='right' readonly></b>
			</td>   
       ...
       <td>
        <table>
         <tr>
			...
			<td align="left">			 	
			 <select name=cuie_origen Style="width=257px" 
			...
			<td align="left">			 	
			 <select name=cuie_destino Style="width=257px" 
        		onKeypress="buscar_combo(this);"
				onblur="borrar_buffer();"
				onchange="borrar_buffer();" 
				>
		...
		<tr>	
			...
			<td align="left">
		    	<?$fecha_control=date("d/m/Y");?>
		    	 <input type=text id=fecha_control name=fecha_control value='<?=$fecha_control;?>' size=15  readonly> 
		    	 <?=link_calendario("fecha_control");?>
		    </td>

			<td align="right">
				<b>Fecha Derivacion:</b>
			</td>	
			<td align="left">	
		    	<?$fecha_derivacion=date("d/m/Y");?>
		    	 <input type=text id=fecha_derivacion name=fecha_derivacion value='<?=$fecha_derivacion;?>' size=15  readonly> 
		    	 <?=link_calendario("fecha_derivacion");?>
		    </td>		    		    
		</tr>  
		...
		<tr>	
			...
			<td align="left">
		    	<?$fecha_prox_control=date("d/m/Y");?>
		    	 <input type=text id=fecha_prox_control name=fecha_prox_control value='<?=$fecha_prox_control;?>' size=15  readonly> 
		    	 <?=link_calendario("fecha_prox_control");?>
		    </td>
			...
			<td align="left">	
		    	<?$fecha_turno=date("d/m/Y");?>
		    	 <input type=text id=fecha_turno name=fecha_turno value='<?=$fecha_turno;?>' size=15  readonly> 
          ...
          <tr>
            ...
            <td align='left'>
              <textarea cols='60' rows='2' name='comentario' ></textarea>
            </td>
         </tr>  		 
        </table>
      </td>      
				...
				<td align="center" bgcolor='<?=$color?>' onclick="<?=$onclick_elegir?>"><?if ($res_comprobante->fields['nom_resp']!="") echo $res_comprobante->fields['nom_resp']; else echo "&nbsp"?></td>
		 		...
		 		<td align="center" onclick="<?//=$onclick_elegir?>"><?if ($res_comprobante->fields['fecha_pcontrol_flag']!="0") echo "NO"; else echo "SI"?></td>			
		 		 <?if (permisos_check('inicio','perm_borra_vacuna')){		 		 	
					...
					$onclick_provincia="if (confirm('Seguro que desea eliminar el registro de vacunaci�n?')) location.href='$ref'"; ?>
